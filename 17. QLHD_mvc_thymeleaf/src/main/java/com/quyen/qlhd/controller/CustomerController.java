...
public class CustomerController {
    ...
    public String createCustomer(@ModelAttribute("CustomerCreationRequest") CustomerCreationRequest customer, Model model) {
    ...
    public String forwardToCustomerUpdate(@PathVariable("customer-id") int id, Model model) {
    ...
    public String updateCustomer(@ModelAttribute("CustomerUpdateRequest") CustomerDetailResponse customer, Model model) {
